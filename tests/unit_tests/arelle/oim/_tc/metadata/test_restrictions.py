...
class TestPermittedRestrictionsSchemaTypes:
    ...
    def test_string_like_types(self, local_name: str) -> None:
        assert permitted_restrictions(f"xs:{local_name}", _xsd(local_name)) == _STRING_RESTRICTIONS

    def test_qname_only_supports_pattern_and_enumeration(self) -> None:
        assert permitted_restrictions("xs:QName", _xsd("QName")) == _PATTERN_AND_ENUM_RESTRICTIONS
    ...
    def test_numeric_types(self, local_name: str) -> None:
        assert permitted_restrictions(f"xs:{local_name}", _xsd(local_name)) == _NUMERIC_RESTRICTIONS
    ...
    def test_time_zoned_types(self, local_name: str) -> None:
        assert permitted_restrictions(f"xs:{local_name}", _xsd(local_name)) == _TIME_ZONED_RESTRICTIONS
    ...
    def test_ordered_non_numeric_types(self, local_name: str) -> None:
        assert permitted_restrictions(f"xs:{local_name}", _xsd(local_name)) == _ORDERED_RESTRICTIONS

    def test_duration_type(self) -> None:
        assert permitted_restrictions("xs:duration", _xsd("duration")) == _DURATION_RESTRICTIONS
...
class TestPermittedRestrictionsCoreTypes:
    def test_concept(self) -> None:
        assert permitted_restrictions("concept", _xsd("QName")) == _PATTERN_AND_ENUM_RESTRICTIONS

    def test_entity(self) -> None:
        assert permitted_restrictions("entity", _xsd("token")) == _STRING_RESTRICTIONS

    def test_period(self) -> None:
        assert permitted_restrictions("period", _xsd("string")) == _PERIOD_RESTRICTIONS

    def test_unit(self) -> None:
        assert permitted_restrictions("unit", _xsd("string")) == _STRING_RESTRICTIONS

    def test_language(self) -> None:
        assert permitted_restrictions("language", _xsd("language")) == _STRING_RESTRICTIONS

    def test_decimals(self) -> None:
        assert permitted_restrictions("decimals", _xsd("integer")) == _NUMERIC_RESTRICTIONS
