...
class ConformanceSuiteConfig:
    ...
    expected_testcase_errors: dict[str, dict[str, int]] = field(default_factory=dict)
    ...
    def __post_init__(self) -> None:
        ...
        overlapping_expected_failure_testcase_ids = self.expected_failure_ids.intersection(self.expected_testcase_errors.keys())
