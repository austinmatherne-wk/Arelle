...
from tests.integration_tests.validation.conformance_suite_configurations.esef_ixbrl_2025 import config as esef_ixbrl_2025
...
from tests.integration_tests.validation.conformance_suite_configurations.esef_xhtml_2025 import config as esef_xhtml_2025
...
from tests.integration_tests.validation.conformance_suite_configurations.nl_inline_2025 import config as nl_inline_2025
from tests.integration_tests.validation.conformance_suite_configurations.ros_current import config as ros_current
from tests.integration_tests.validation.conformance_suite_configurations.uksef import config as uksef
...
from tests.integration_tests.validation.conformance_suite_configurations.xbrl_table_constraints_1_0 import config as xbrl_table_constraints_1_0
from tests.integration_tests.validation.conformance_suite_configurations.xbrl_table_constraints_1_1 import config as xbrl_table_constraints_1_1
...
ALL_CONFORMANCE_SUITE_CONFIGS: tuple[ConformanceSuiteConfig, ...] = (
    ...
    xbrl_table_constraints_1_0,
    xbrl_table_constraints_1_1,
