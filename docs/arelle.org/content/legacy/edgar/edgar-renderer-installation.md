...
2. Install from sources on GitHub. ([See Technical Operation](/arelle/documentation/edgar-renderer-technical-operation/))
...
2. Technical Operation: from command line, as a web service, or polled operation as a daemon service. ([See Technical Operation](/arelle/documentation/edgar-renderer-technical-operation/))

## Installing

### Pre-built application

Pre-built applications for Windows, macOS and Linux are on the [Arelle download page](/download/), which offers each build from the US, EU and CN mirrors.
