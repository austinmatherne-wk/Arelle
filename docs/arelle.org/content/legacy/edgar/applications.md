...
- Pre-built application with EDGAR renderer and local viewer (based on Arelle), for Windows, macOS and Linux, from the [Arelle download page](/download/):
...
- [Documentation of EDGAR Renderer installation](/arelle/pub/edgar-renderer-installation/)
- EDGAR Renderer source code for developers: [Arelle/EDGAR on GitHub](https://github.com/Arelle/EDGAR)
- Current plugin documentation: [EDGAR on Read the Docs](https://arelle.readthedocs.io/en/latest/plugins/popular/edgar.html)
