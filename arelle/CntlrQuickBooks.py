...
def processQbResponse(qbRequest: dict[str, str], responseXml: str) -> None:
    ...
    monetaryUnit = QName("iso4217", XbrlConst.iso4217, "USD")
    ...
    isoLanguage = QName("iso639", "http://www.xbrl.org/2005/iso639", "en")
    ...
    accountingEntries = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "accountingEntries"))

    # Because entriesType is strongly suggested, documentInfo will be required
    docInfo = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "documentInfo"), parent=accountingEntries)
    # This field, entriesType, provides the automated guidance on the purpose of the XBRL GL information.
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entriesType"), parent=docInfo, attributes=nonNumAttr,
    ...
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "uniqueID"), parent=docInfo, attributes=nonNumAttr,
                        text="001")
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "language"), parent=docInfo, attributes=nonNumAttr,
    ...
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "creationDate"), parent=docInfo, attributes=nonNumAttr,
                        text=str(datetime.date.today()))
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "periodCoveredStart"), parent=docInfo, attributes=nonNumAttr,
                        text=fromDate)
    instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "periodCoveredEnd"), parent=docInfo, attributes=nonNumAttr,
                        text=toDate)
    instance.createFact(QName("gl-bus", "http://www.xbrl.org/int/gl/bus/2006-10-25", "sourceApplication"), parent=docInfo, attributes=nonNumAttr,
                        text=docEltText(companyQbDoc, "ProductName","QuickBooks (version not known)"))
    instance.createFact(QName("gl-muc", "http://www.xbrl.org/int/gl/muc/2006-10-25", "defaultCurrency"), parent=docInfo, attributes=nonNumAttr,
    ...
    entityInfo = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entityInformation"), parent=accountingEntries)
    ...
    orgIds = instance.createFact(QName("gl-bus", "http://www.xbrl.org/int/gl/bus/2006-10-25", "organizationIdentifiers"), parent=entityInfo)
    instance.createFact(QName("gl-bus", "http://www.xbrl.org/int/gl/bus/2006-10-25", "organizationIdentifier"), parent=orgIds, attributes=nonNumAttr,
                        text=docEltText(companyQbDoc, "CompanyName"))
    instance.createFact(QName("gl-bus", "http://www.xbrl.org/int/gl/bus/2006-10-25", "organizationDescription"), parent=orgIds, attributes=nonNumAttr,
    ...
    for dataRowElt in responseQbDoc.iter("DataRow"):
        ...
        if isFirst or qbTxnNumber:
            ...
            entryHdr = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entryHeader"), parent=accountingEntries)
            ...
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "enteredDate"), parent=entryHdr, attributes=nonNumAttr,
                                text=str(datetime.date.today()))
            ...
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "sourceJournalID"), parent=entryHdr, attributes=nonNumAttr,
                                text="gj")
            ...
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entryType"), parent=entryHdr, attributes=nonNumAttr,
                                text="standard")
            ...
            is entered here."""
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entryNumber"), parent=entryHdr, attributes=nonNumAttr,
                                text=str(entryNumber))
            entryNumber += 1
            # The reason for making an entry goes here.
            if qbRefNumber:
                instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entryComment"), parent=entryHdr, attributes=nonNumAttr,
                                    text=qbRefNumber)
        ...
        entryDetail = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "entryDetail"), parent=entryHdr)
        # A unique identifier for each entry detail line within an entry header, this should at the least be a counter.
        instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "lineNumber"), parent=entryDetail, attributes=nonNumAttr,
                            text=str(lineNumber))
        lineNumber += 1
        ...
        account = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "account"), parent=entryDetail)
        ...
        if qbAccount:
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "accountMainDescription"), parent=account, attributes=nonNumAttr,
                                text=qbAccount)
        ...
        instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "accountPurposeCode"), parent=account, attributes=nonNumAttr,
                            text="usgaap")
        ...
        instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "accountType"), parent=account, attributes=nonNumAttr, text="account")
        ...
        instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "amount"), parent=entryDetail, attributes=monetaryAttr,  # type: ignore[arg-type]
                            text=amt)
        ...
        if drCrCode:
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "debitCreditCode"), parent=entryDetail, attributes=nonNumAttr,
                                text=drCrCode)
        """Depending on the originating system, this field may contain whether the amount is
        ...
        if qbDate:
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "postingDate"), parent=entryDetail, attributes=nonNumAttr,
                                text=qbDate)

        if qbName or qbMemo:
            identRef = instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "identifierReference"), parent=entryDetail)
            if qbMemo:
                instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "identifierCode"), parent=identRef, attributes=nonNumAttr,
                                    text=qbMemo)
            if qbName:
                instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "identifierDescription"), parent=identRef, attributes=nonNumAttr,
                                    text=qbName)
        ...
        if qbReport != "trialBalance":
            if qbTxnType: # not exactly same enumerations as expected by QB
                ...
                instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "documentType"), parent=entryDetail, attributes=nonNumAttr,
                                    text=glDocType)

            """This enumerated field is used to specifically state whether the entries have been
            posted to the originating system or not."""
            instance.createFact(QName("gl-cor", "http://www.xbrl.org/int/gl/cor/2006-10-25", "postingStatus"), parent=entryDetail, attributes=nonNumAttr,
                                text="posted")
